...
app.get('/', (req, res) => {
  res.json({
    name: 'Ipps Patients Data Api',
    version: '0.1.0',
    client: {
      url: 'https://ipps.now.sh',
      repo: 'https://github.com/eeegor/ipps-client'
    },
    api: {
      url: 'https://ipps-api.now.sh',
      repo: 'https://github.com/eeegor/ipps-api',
      endpoints: {
        signup: {
          method: 'POST',
          body: {
